...
LABEL = {
    "standing": ("いま立っている", "この主張は取り下げていません。反証の手順を添えてある"),
    "corrected": ("直した", "誤りが見つかり、直したもの。元の記述は消していません"),
    "withdrawn": ("撤回した", "取り下げたもの。元の記述は消していません"),
    "unresolvable": ("直せない", "凍結された成果物の側に誤りがあります。もう直せません"),
    "open": ("未解決", "まだ判断がついていません"),
}
